...
include <weather_station_pvc_flange_pole_mount.scad>
...
x_dist = in_to_mm(3/sqrt(2)); // x hole spacing
y_dist = x_dist; // y hole spacing

rot_cap_lw = 83; // rotating part to set correct north/south angle
rot_cap_theta = 0; // rot cap rotation -- was 30
...
translate([0, 0, bott_cap_h + top_t])
